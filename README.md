...
`NativeExecutionHost` remains the default host. For a visible terminal run, opt
into the dependency-free `TmuxExecutionHost` (the `tmux` executable itself is an optional system
prerequisite):
